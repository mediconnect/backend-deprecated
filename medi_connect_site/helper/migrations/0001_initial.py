# -*- coding: utf-8 -*-
# Generated by Django 1.11.2 on 2017-07-09 00:22
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='order',
            name='translator_C2E',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='chinese_translator', to='translator.Translator_C2E'),
        ),
        migrations.AddField(
            model_name='order',
            name='translator_E2C',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='english_translator', to='translator.Translator_E2C'),
        ),
        migrations.AddField(
            model_name='document',
            name='order',
